...
void MainWindow::on_pushButton_6_clicked()
{
    ...
    //    cv::fillPoly(ui->graphicsView->srcImg, contours, cv::Scalar(255,255,0));//fillPoly函数的第二个参数是二维数组！！
//    cv::polylines(ui->graphicsView->srcImg, contours, true, cv::Scalar(255, 255, 0), 1, cv::LINE_AA);//第2个参数可以采用contour或者contours，均可
    Mat img2;
...
void MainWindow::on_pushButton_13_clicked()
{
    ...
    auto & grayImg=ui->graphicsView_2->grayImg;
    ...
    ui->lineEdit_14->setText(QString::number(srcImg.cols));
    ui->lineEdit_15->setText(QString::number(srcImg.rows));
